...
return new class extends Migration {
    public function up(): void
    {
        ...
        if ($driver === 'pgsql') {
            // PostgreSQL: Create native ENUM types and convert columns
            DB::statement("DO $$ BEGIN CREATE TYPE goal_priority AS ENUM ('high', 'medium', 'low'); EXCEPTION WHEN duplicate_object THEN null; END $$;");
            DB::statement("DO $$ BEGIN CREATE TYPE todo_source AS ENUM ('paste', 'csv', 'api', 'api_batch'); EXCEPTION WHEN duplicate_object THEN null; END $$;");
        ...
        // SQLite & MySQL: Keep columns as VARCHAR - no action needed
        // The application validates enum values in the model layer
    }
    ...
    public function down(): void
    {
        ...
        // SQLite & MySQL: Nothing to revert
    }
};
